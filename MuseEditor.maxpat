		...
		"boxes": [
			...
			},
			{
				"box": {
					...
					"text": "The Muse's knobs sync per-CC on every tab.",
					"fontsize": 8.0,
					"fontface": 0,
					"textjustification": 0,
					"varname": "ms_h2"
			...
			},
			{
				"box": {
					...
					"text": "script show Panic, script show ms_l1, script show ms_h1, script show ms_h2, script show ms_h3"
				}
			},
			{
				"box": {
